...
#import "MDCInputTextArea+MaterialTheming.h"
...
@implementation MDCInputTextArea (MaterialTheming)
...
- (void)applyOutlinedThemeWithScheme:(nonnull id<MDCContainerScheming>)containerScheme {
  ...
  MDCInputTextAreaOutlinedDensityInformer *densityInformer =
      [[MDCInputTextAreaOutlinedDensityInformer alloc] init];
...
- (void)applyFilledThemeWithScheme:(nonnull id<MDCContainerScheming>)containerScheme {
  ...
  MDCInputTextAreaFilledDensityInformer *densityInformer =
      [[MDCInputTextAreaFilledDensityInformer alloc] init];
...
//@interface MDCInputTextAreaFilledDensityInformer ()
//@end

@implementation MDCInputTextAreaFilledDensityInformer
...
@implementation MDCInputTextAreaOutlinedDensityInformer
