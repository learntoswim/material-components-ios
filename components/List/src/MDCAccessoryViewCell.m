...
@property(nonatomic, strong)
    NSMutableDictionary<NSNumber *, MDCAccessoryViewCellLayout *> *cachedLayouts;

@end

@implementation MDCAccessoryViewCell
...
- (void)layoutSubviews {
  ...
  MDCAccessoryViewCellLayout *layout = [self layoutForCellWidth:self.frame.size.width];
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)targetSize {
  MDCAccessoryViewCellLayout *layout = [self layoutForCellWidth:targetSize.width];
...
- (MDCAccessoryViewCellLayout *)layoutForCellWidth:(CGFloat)cellWidth {
  CGFloat flooredCellWidth = MDCFloor(cellWidth);
  MDCAccessoryViewCellLayout *layout = self.cachedLayouts[@(flooredCellWidth)];
  if (!layout) {
    layout = [[MDCAccessoryViewCellLayout alloc] initWithLeadingAccessoryView:self.leadingAccessoryView
