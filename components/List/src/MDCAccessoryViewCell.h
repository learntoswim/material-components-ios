...
/**
 MDCAccessoryViewCell is intended to be an easy to use readymade implementation of a basic
 ...
 */
__attribute__((objc_subclassing_restricted)) @interface MDCAccessoryViewCell : MDCBaseCell
